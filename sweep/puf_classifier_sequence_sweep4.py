...
for sequence_size in range(5300, 7000, 50):
...
results_df.to_csv("sweep/sequence_size_sweep_results/results4.csv", index=False)
print("Results saved to results4.csv")