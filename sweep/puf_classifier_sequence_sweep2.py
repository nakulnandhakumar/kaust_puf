...
for sequence_size in range(1900, 3600, 50):
...
results_df.to_csv("sweep/sequence_size_sweep_results/results2.csv", index=False)
print("Results saved to results2.csv")