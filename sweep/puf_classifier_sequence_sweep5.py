...
for sequence_size in range(7000, 8700, 50):
...
results_df.to_csv("sweep/sequence_size_sweep_results/results5.csv", index=False)
print("Results saved to results5.csv")